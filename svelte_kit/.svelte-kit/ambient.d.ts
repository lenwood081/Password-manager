...
declare module '$env/static/private' {
	export const EXPRESS_URL_DEV: string;
	export const EXPRESS_URL_PROD: string;
	export const NODE_DEV: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		EXPRESS_URL_DEV: string;
		EXPRESS_URL_PROD: string;
		NODE_DEV: string;
		MONGODB_URI: string;
		DB_NAME: string;
		NODE_ENV: string;
